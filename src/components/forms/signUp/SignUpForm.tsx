...
export default class AuthenticationForm extends React.Component<SignUpProp, AuthenticationState> {
            ...
            <BForm onSubmit={this.handleSubmit}>
                ...
                <BForm.Row>
                    <BForm.Group controlId="formBasicEmail">
                        ...
                        <BForm.Control type="email" placeholder="Enter email" value={this.state.email} onChange={this.emailOnChangeHandler} required={true}/>
                    </BForm.Group>
                </BForm.Row>
                ...
                <BForm.Row>
                    <BForm.Group controlId="formBasicFirstName">
                        ...
                        <BForm.Control type="text" placeholder="Enter your firstname" value={this.state.firstname} onChange={this.firstnameOnChangeHandler}  required={true}/>
                    </BForm.Group>
                    
                    <BForm.Group controlId="formBasicLastName">
                        <BForm.Label>Lastname : </BForm.Label>
                        <BForm.Control type="text" placeholder="Enter your lastname" value={this.state.lastname} onChange={this.lastnameOnChangeHandler}  required={true}/>
                    </BForm.Group>
                </BForm.Row>
                ...
                <BForm.Row>
                    <BForm.Group controlId="formBasicPassword">
                        ...
                        <BForm.Control type="password" placeholder="Enter your password" value={this.state.password} onChange={this.passwordOnChangeHandler}  required={true}/>
                    </BForm.Group>

                    <BForm.Group controlId="formBasicConfirmPassword">
                        <BForm.Label>Password : </BForm.Label>
                        <BForm.Control type="password" placeholder="Confirm your password" value={this.state.confirmPassord} onChange={this.confirmPasswordOnChangeHandler}  required={true} isValid={this.state.password !== '' && this.state.password === this.state.confirmPassord}/>
                    </BForm.Group>
                </BForm.Row>

                <BForm.Row>
                    <BButton type="submit" disabled={!this.isValidState()}>Submit</BButton>
                </BForm.Row>
            </BForm>
        )
    }
    ...
    isValidState(): boolean {
        ...
        if (this.state.lastname === '')
            return false;
        if (this.state.password === '' || this.state.password !== this.state.confirmPassord)
            return false;
        return true
    }
